...
//! definition. However, most basic types suck as `OCETET STRING` or `BMPString` are represented by
//! their own distinctive types to avoid confusion.
//!
//! Structures defined in this module are were built in such wat that allows maximum backwards and
//! forwards compatibility with other PKCS#12 implementations by wrapping unknown veriants and
...
//! data. See code examples in this file for full unencrypted PFX file contents parsing.
//!
