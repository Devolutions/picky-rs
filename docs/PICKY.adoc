...
The application/ocsp-request is used to indicate an application OCSP request, as defined in https://tools.ietf.org/html/rfc6960#appendix-C.1[RFC 6960 Appendix C.1]
...
The application/ocsp-response is used to indicate an application OCSP response, as defined in https://tools.ietf.org/html/rfc6960#appendix-C.2[RFC 6960 Appendix C.2]
