...
public partial struct JwtSig
{
    ...
    public static unsafe extern JwtFfiResultVoidBoxPickyError GetContentType(JwtSig* self, DiplomatWriteable* writeable);

    /// <summary>
    /// Returns the key ID.
    /// </summary>
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, EntryPoint = "JwtSig_get_kid", ExactSpelling = true)]
    public static unsafe extern JwtFfiResultVoidBoxPickyError GetKid(JwtSig* self, DiplomatWriteable* writeable);
    ...
    public static unsafe extern JwtFfiResultVoidBoxPickyError GetHeader(JwtSig* self, DiplomatWriteable* writeable);
    ...
    public static unsafe extern JwtFfiResultVoidBoxPickyError GetClaims(JwtSig* self, DiplomatWriteable* writeable);
    ...
    public static unsafe extern JwtFfiResultBoxJwtSigBoxPickyError Decode(byte* compactRepr, nuint compactReprSz, PublicKey* publicKey, JwtValidator* validator);
    ...
    public static unsafe extern JwtFfiResultBoxJwtSigBoxPickyError DecodeUnchecked(byte* compactRepr, nuint compactReprSz);
    ...
    public static unsafe extern JwtFfiResultVoidBoxPickyError Encode(JwtSig* self, PrivateKey* key, DiplomatWriteable* writeable);
