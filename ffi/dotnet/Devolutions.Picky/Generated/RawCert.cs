...
public partial struct Cert
{
    ...
    public static unsafe extern IntPtr ToPem(Cert* self);
    ...
    public static unsafe extern IntPtr GetSubjectKeyIdHex(Cert* self, DiplomatWriteable* writeable);

    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, EntryPoint = "Cert_get_subject_name", ExactSpelling = true)]
    public static unsafe extern IntPtr GetSubjectName(Cert* self, DiplomatWriteable* writeable);

    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, EntryPoint = "Cert_get_issuer_name", ExactSpelling = true)]
    public static unsafe extern IntPtr GetIssuerName(Cert* self, DiplomatWriteable* writeable);
